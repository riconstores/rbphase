...
if(! defined('DEFAULT_WIDTH') )				define ('DEFAULT_WIDTH', 500);							// Default thumbnail width. Allows overrid in timthumb-config.php
if(! defined('DEFAULT_HEIGHT') )			define ('DEFAULT_HEIGHT', 500);							// Default thumbnail height. Allows overrid in timthumb-config.php
